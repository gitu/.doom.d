...
;(after! org-mode
;    (set-company-backend! 'company-org-roam)
;)
#END_SRC
** Org Journal
#+BEGIN_SRC emacs-lisp
...
#+RESULTS:
| k | Tasks   | ((agenda  ((org-agenda-overriding-header Agenda) (org-agenda-span (quote 1)) (org-agenda-start-day (org-today)) (org-agenda-files my-task-files))) (todo  ((org-agenda-overriding-header Tasks) (org-agenda-skip-function (quote (or (and (org-agenda-skip-entry-if (quote notregexp) #[A-C]) (org-agenda-skip-entry-if (quote notregexp) :@\w+)) (org-agenda-skip-if nil (quote (scheduled deadline))) (org-agenda-skip-if (quote todo) (quote (SOMEDAY)))))) (org-agenda-files my-task-files) (org-super-agenda-groups (quote ((:name Priority Items :priority>= B) (:auto-parent t)))))) (todo  ((org-agenda-overriding-header Delegated Tasks) (org-agenda-files my-task-files) (org-tags-match-list-sublevels t) (org-agenda-skip-function (quote (or (org-agenda-skip-subtree-if (quote nottodo) (quote (DELEGATED)))))) (org-super-agenda-groups (quote ((:auto-property WHO))))))) | nil | (~/org/ax/tasks.html ~/org/ax/tasks.txt) |
| n | Notes   | ((todo  ((org-agenda-overriding-header Note Actions) (org-agenda-files my-notes-files) (org-super-agenda-groups (quote ((:auto-category t)))))))                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |     |                                          |
| i | Inbox   | ((todo  ((org-agenda-overriding-header Inbox) (org-agenda-skip-function (quote (or (org-agenda-skip-entry-if (quote regexp) :@\w+) (org-agenda-skip-entry-if (quote regexp) [#[A-E]]) (org-agenda-skip-if (quote nil) (quote (scheduled deadline))) (org-agenda-skip-entry-if (quote todo) (quote (SOMEDAY))) (org-agenda-skip-entry-if (quote todo) (quote (DELEGATED)))))) (org-agenda-files my-task-files) (org-super-agenda-groups (quote ((:auto-ts t)))))))                                                                                                                                                                                                                                                                                                                                                                                                                          |     |                                          |
| s | Someday | ((todo  ((org-agenda-overriding-header Someday) (org-agenda-skip-function (quote (or (org-agenda-skip-entry-if (quote nottodo) (quote (SOMEDAY)))))) (org-agenda-files my-task-files) (org-super-agenda-groups (quote ((:auto-parent t)))))))                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |     |                                          |
